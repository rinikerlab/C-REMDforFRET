...
from Forces.Nonbonded import Custom_electrostatic, Custom_lennard_jones, Custom_exception_force
...
class ReplicaExchange:
    ...
    def __init__(self, prmtop, inpcrd, number_of_replicas=1):
        ...
        # Create simulation NOTE: cutoff defined in custom forces
    ...
    def replace_nonbonded_force_with_custom(self):
        ...
        for custom_force in [Custom_electrostatic, Custom_lennard_jones, Custom_exception_force]:
            cf = custom_force()
    ...
    def add_reporters(self,n_interval = 1000,runname='test'):

        #self._simulation.reporters.append(app.StateDataReporter(stdout, n_interval, step=True,
        #                                                  potentialEnergy=True, kineticEnergy=True, temperature=True,
        #                                                  speed=True))
        self._simulation.reporters.append(HDF5Reporter(runname + '_output.h5', n_interval))
    ...
    def try_exchange(self,indices):
        ...
        for i,j in indices:
            ...
            if prob > np.random.rand(1):
                ...
                #print('states exchanged at prob :%.3f from %i to %i' % (prob,i,j))
